...
public record ProjectileData(List<String> blocks, String item, boolean returns, boolean drops, boolean removes, double launchVelocity, double damping, double threshold) {
